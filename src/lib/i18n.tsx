...
const translations = {
  ...
  "relay.subtitle": { en: "Deliver games between neighborhoods — earn badges, build community", he: "העבר משחקים בין שכונות — צבור תגים, בנה קהילה" },
  "relay.how_it_works": { en: "How it works", he: "איך זה עובד" },
  "relay.step1": { en: "Someone requests a game from another neighborhood", he: "מישהו מבקש משחק משכונה אחרת" },
  "relay.step2": { en: "You pick it up and deliver it — no more than 2.5 km", he: "אתה אוסף ומעביר — לא יותר מ-2.5 ק\"מ" },
  "relay.step3": { en: "Earn badges and climb the leaderboard", he: "צבור תגים וטפס בטבלה" },
  "relay.from_neighborhood": { en: "Your neighborhood", he: "השכונה שלך" },
  "relay.to_neighborhood": { en: "Willing to deliver to", he: "מוכן לספק ל" },
  "relay.available_days": { en: "Available days", he: "ימים פנויים" },
  "relay.available_hours": { en: "Available hours", he: "שעות פנויות" },
  "relay.available_hours_placeholder": { en: "e.g. Afternoons, Evenings", he: "לדוגמה: אחה\"צ, ערב" },
  "relay.sign_up": { en: "Sign Up as Courier", he: "הירשם כשליח" },
  "relay.already_volunteer": { en: "You're already a relay courier!", he: "אתה כבר שליח!" },
  "relay.already_sub": { en: "Thanks for volunteering. You'll be matched with deliveries near you.", he: "תודה על ההתנדבות. נתאים אותך למשלוחים קרובים." },
  "relay.success": { en: "You're in! Welcome to the courier team.", he: "יצאת לדרך! ברוך הבא לצוות השליחים." },
  "relay.error": { en: "Something went wrong. Please try again.", he: "משהו השתבש. נסה שוב." },
  "relay.sign_in_required": { en: "Sign in to become a relay courier", he: "התחבר כדי להפוך לשליח" },
  "relay.perks_title": { en: "Why volunteer?", he: "למה להתנדב?" },
  "relay.perk1": { en: "Earn exclusive badges visible on your profile", he: "צבור תגים בלעדיים הנראים בפרופיל שלך" },
